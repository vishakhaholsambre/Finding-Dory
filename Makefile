...
SOURCES            = main.c game.c myLib.c spritesheet.c start.c instructions.c ocean.c oceanfront.c pause.c win.c lose.c sound.c shellsound.c bump.c wipe.c TitleSong.c
CCPATH             = /usr/bin
